...
run_one rn50_align_par_normal_allparam_s42 \
  --mode normal --compute_proxy_diagnostic --null_samples 8
run_one rn50_align_par_project_oracle_allparam_s42 \
  --mode project --project_trigger oracle --project_harmful_only
run_one rn50_align_par_random_matched_allparam_s42 \
